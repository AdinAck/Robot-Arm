...
class Visual(Widget):
    ...
    def loop(self):
        while self.running:
            ...
            self._drawArms(self.curr_l1, self.curr_l2, self.control._system.m2.position, self.control._system.m3.position, (
                self.control._system.m2._sendCommand('MMG1', float), self.control._system.m3._sendCommand('MMG1', float)))
